...
public class HomeTransactionsRevenueFrame extends javax.swing.JDialog {
    ...
    private void show1() {
        ...
        try {
            ...
            Logger.getLogger(HomeTransactionsRevenueFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
        model.setRowCount(0);
        money = 0;
    ...
    private void initComponents() {
        ...
        lblHoachToan.setText("Báo cáo doanh thu giao dịch nhà");
    ...
    private void miOpenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_miOpenActionPerformed
        JOptionPane.showMessageDialog(null, "Phiên bản 8.2", "Giới thiệu", JOptionPane.INFORMATION_MESSAGE);
