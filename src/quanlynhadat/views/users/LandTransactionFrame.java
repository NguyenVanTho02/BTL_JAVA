...
public class LandTransactionFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbLoaiDat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbLoaiDatActionPerformed(evt);
            }
        });
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        if (responseConfirm == JOptionPane.YES_OPTION) {
            if (!LandTransactionController.deleteTransaction(idUser, Integer.parseInt( txtMaDG.getText()))) {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try{
            transactions = List.copyOf(LandTransactionController.getAllTransactionByUser(idUser));
        }catch( IOException ex){
    ...
    private void txtTimKiemKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtTimKiemKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if ("".equals(txtTimKiem.getText().trim()) || txtTimKiem == null) {
                ...
                try {
                    Transaction t = LandTransactionController.getTransactionByUser(idUser,Integer.parseInt(txtTimKiem.getText()));
                    String x = t.getT_type();
                    float tt = 0;
                    float dg = t.getT_price();
                    float s = t.getT_area();
    ...
    private void cbLoaiDatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbLoaiDatActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cbLoaiDatActionPerformed
