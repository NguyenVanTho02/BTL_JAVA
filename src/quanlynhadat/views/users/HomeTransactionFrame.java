...
public class HomeTransactionFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbLoaiDat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "cao cấp", "thuong" }));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(cbLoaiDat, 0, 157, Short.MAX_VALUE)
    ...
    private void tbGDNhaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbGDNhaMouseClicked
        ...
        Transaction t = null;
            try {
                t  = LandTransactionController.getTransactionByUser(idUser, Integer.parseInt(v.get(1).toString()));
            } catch (IOException ex) {
                Logger.getLogger(LandTransactionFrame.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        try {
            if (txtMaDG.getText().trim().compareTo("") != 0) {
                JOptionPane.showConfirmDialog(null, " Bạn phải nhập mới!", "Lỗi thêm giao dịch nhà", JOptionPane.DEFAULT_OPTION, JOptionPane.ERROR_MESSAGE);
            ...
            if (txtDienTich.getText().trim().compareTo("") == 0) {
                JOptionPane.showConfirmDialog(null, "Diện tích không được để trống!", "Lỗi thêm mới", JOptionPane.DEFAULT_OPTION, JOptionPane.ERROR_MESSAGE);
                return;
            }
...
Transaction x = new Transaction(id,ngay, dg, ld, dt, idUser);
...
btnResetActionPerformed(null);
            ...
            Logger.getLogger(HomeTransactionFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        if (responseConfirm == JOptionPane.YES_OPTION) {
            try {
                if (!HomeTransactionController.updateTransaction(x)) {
                    JOptionPane.showConfirmDialog(null, "Sửa giao dịch nhà thất bại!", "Lỗi sửa giao dịch thất bại", JOptionPane.DEFAULT_OPTION, JOptionPane.ERROR_MESSAGE);
                    return;
                }
                JOptionPane.showConfirmDialog(null, "Sửa giao dịch thành công!", "Sửa giao dịch", JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE);
                DefaultTableModel model = (DefaultTableModel) tbGDNha.getModel();
                model.setRowCount(0);
                formWindowOpened(null);
            } catch (IOException ex) {
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        if (responseConfirm == JOptionPane.YES_OPTION) {
            if (!HomeTransactionController.deleteTransaction(idUser, Integer.parseInt( txtMaDG.getText()))) {
                JOptionPane.showConfirmDialog(null, "Xoá giao dịch nhà thất bại!", " Lỗi xoá giao dịch nhà", JOptionPane.DEFAULT_OPTION, JOptionPane.ERROR_MESSAGE);
                return;
            }
            JOptionPane.showConfirmDialog(null, "Xoá giao dịch nhà thành công!", "Xoá giao dịch", JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE);
            DefaultTableModel model = (DefaultTableModel) tbGDNha.getModel();
            model.setRowCount(0);
            formWindowOpened(null);
        }
    ...
    private void txtTimKiemKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtTimKiemKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if ("".equals(txtTimKiem.getText().trim()) || txtTimKiem == null) {
                ...
                try {
                    Transaction t = HomeTransactionController.getTransactionByUser(idUser, Integer.parseInt(txtTimKiem.getText()));
                    String x = t.getT_type();
                    float dg = t.getT_price();
                    String ld = cbLoaiDat.getSelectedItem().toString();
                    float tt = 0;
                    ...
                    JOptionPane.showConfirmDialog(null, "Không tìm thấy giao dịch nào!", "Tìm kiếm", JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE);
                    DefaultTableModel model = (DefaultTableModel) tbGDNha.getModel();
                    model.setRowCount(0);
                    formWindowOpened(null);
